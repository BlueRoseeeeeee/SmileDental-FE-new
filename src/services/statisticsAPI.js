...
// Dentists (Nha sỹ) - EXPANDED
const MOCK_DENTISTS = [
  { id: 'D001', name: 'BS. Nguyễn Văn An', employeeCode: 'NV00000001', specialization: 'Phục hình', experience: 12, rating: 4.9 },
  { id: 'D002', name: 'BS. Trần Thị Bảo', employeeCode: 'NV00000002', specialization: 'Nha chu', experience: 8, rating: 4.8 },
  { id: 'D003', name: 'BS. Lê Văn Cường', employeeCode: 'NV00000003', specialization: 'Chỉnh nha', experience: 15, rating: 4.9 },
  { id: 'D004', name: 'BS. Phạm Thị Diệu', employeeCode: 'NV00000004', specialization: 'Implant', experience: 10, rating: 4.7 },
  { id: 'D005', name: 'BS. Hoàng Văn Em', employeeCode: 'NV00000005', specialization: 'Nội nha', experience: 7, rating: 4.6 },
  { id: 'D006', name: 'BS. Ngô Thị Phương', employeeCode: 'NV00000006', specialization: 'Răng sứ', experience: 9, rating: 4.8 },
  { id: 'D007', name: 'BS. Đỗ Văn Giang', employeeCode: 'NV00000007', specialization: 'Tổng quát', experience: 5, rating: 4.5 },
  { id: 'D008', name: 'BS. Vũ Thị Hương', employeeCode: 'NV00000008', specialization: 'Thẩm mỹ', experience: 11, rating: 4.9 },
  { id: 'D009', name: 'BS. Bùi Văn Khôi', employeeCode: 'NV00000009', specialization: 'Phẫu thuật', experience: 13, rating: 4.8 },
  { id: 'D010', name: 'BS. Đặng Thị Lan', employeeCode: 'NV00000010', specialization: 'Nha khoa trẻ em', experience: 6, rating: 4.7 },
  { id: 'D011', name: 'BS. Võ Văn Minh', employeeCode: 'NV00000011', specialization: 'Implant', experience: 14, rating: 4.9 },
  { id: 'D012', name: 'BS. Phan Thị Ngọc', employeeCode: 'NV00000012', specialization: 'Chỉnh nha', experience: 9, rating: 4.7 },
  { id: 'D013', name: 'BS. Lý Văn Ông', employeeCode: 'NV00000013', specialization: 'Phục hình', experience: 8, rating: 4.6 },
  { id: 'D014', name: 'BS. Trương Thị Phượng', employeeCode: 'NV00000014', specialization: 'Răng sứ', experience: 10, rating: 4.8 },
  { id: 'D015', name: 'BS. Nguyễn Văn Quân', employeeCode: 'NV00000015', specialization: 'Nha chu', experience: 7, rating: 4.6 }
];

// Services (Dịch vụ) - EXPANDED
const MOCK_SERVICES = [
  // Exam services (Dịch vụ khám)
  { id: 'SV001', name: 'Khám tổng quát', type: 'exam', category: 'general', basePrice: 200000, duration: 30 },
  { id: 'SV002', name: 'Khám nha chu', type: 'exam', category: 'periodontics', basePrice: 300000, duration: 45 },
  { id: 'SV003', name: 'Khám chỉnh nha', type: 'exam', category: 'orthodontics', basePrice: 500000, duration: 60 },
  { id: 'SV004', name: 'Tư vấn implant', type: 'exam', category: 'implant', basePrice: 0, duration: 30 },
  { id: 'SV005', name: 'Khám răng trẻ em', type: 'exam', category: 'pediatric', basePrice: 250000, duration: 30 },
  
  // High-value treatment services (Dịch vụ điều trị giá cao)
  { id: 'SV006', name: 'Răng sứ thẩm mỹ Emax', type: 'treatment', category: 'cosmetic', basePrice: 6000000, duration: 120 },
  { id: 'SV007', name: 'Răng sứ Titan', type: 'treatment', category: 'cosmetic', basePrice: 3500000, duration: 90 },
  { id: 'SV008', name: 'Cấy ghép Implant Nobel', type: 'treatment', category: 'implant', basePrice: 18000000, duration: 180 },
  { id: 'SV009', name: 'Cấy ghép Implant Osstem', type: 'treatment', category: 'implant', basePrice: 12000000, duration: 150 },
  { id: 'SV010', name: 'Niềng răng Invisalign', type: 'treatment', category: 'orthodontics', basePrice: 85000000, duration: 90 },
  { id: 'SV011', name: 'Niềng răng mắc cài kim loại', type: 'treatment', category: 'orthodontics', basePrice: 35000000, duration: 90 },
  { id: 'SV012', name: 'Niềng răng mắc cài sứ', type: 'treatment', category: 'orthodontics', basePrice: 45000000, duration: 90 },
  { id: 'SV013', name: 'Cấy ghép xương hàm', type: 'treatment', category: 'implant', basePrice: 15000000, duration: 150 },
  { id: 'SV014', name: 'Nâng xoang hàm', type: 'treatment', category: 'implant', basePrice: 20000000, duration: 180 },
  
  // Medium-value treatment services (Dịch vụ điều trị giá trung bình)
  { id: 'SV015', name: 'Tẩy trắng răng Laser', type: 'treatment', category: 'cosmetic', basePrice: 4000000, duration: 90 },
  { id: 'SV016', name: 'Tẩy trắng răng tại nhà', type: 'treatment', category: 'cosmetic', basePrice: 2500000, duration: 60 },
  { id: 'SV017', name: 'Bọc răng sứ toàn phần', type: 'treatment', category: 'cosmetic', basePrice: 4500000, duration: 120 },
  { id: 'SV018', name: 'Veneer sứ', type: 'treatment', category: 'cosmetic', basePrice: 5500000, duration: 90 },
  { id: 'SV019', name: 'Điều trị tủy răng hàm', type: 'treatment', category: 'endodontics', basePrice: 2500000, duration: 90 },
  { id: 'SV020', name: 'Điều trị tủy răng cửa', type: 'treatment', category: 'endodontics', basePrice: 1800000, duration: 60 },
  
  // Low-value treatment services (Dịch vụ điều trị giá thấp)
  { id: 'SV021', name: 'Nhổ răng khôn', type: 'treatment', category: 'surgery', basePrice: 1500000, duration: 45 },
  { id: 'SV022', name: 'Nhổ răng sữa', type: 'treatment', category: 'pediatric', basePrice: 300000, duration: 20 },
  { id: 'SV023', name: 'Nhổ răng thường', type: 'treatment', category: 'surgery', basePrice: 500000, duration: 30 },
  { id: 'SV024', name: 'Trám răng Composite', type: 'treatment', category: 'restorative', basePrice: 600000, duration: 45 },
  { id: 'SV025', name: 'Trám răng GIC', type: 'treatment', category: 'restorative', basePrice: 400000, duration: 30 },
  { id: 'SV026', name: 'Trám răng Amalgam', type: 'treatment', category: 'restorative', basePrice: 350000, duration: 30 },
  { id: 'SV027', name: 'Lấy cao răng', type: 'treatment', category: 'periodontics', basePrice: 500000, duration: 45 },
  { id: 'SV028', name: 'Cạo vôi răng', type: 'treatment', category: 'periodontics', basePrice: 350000, duration: 30 },
  { id: 'SV029', name: 'Làm sạch răng sâu', type: 'treatment', category: 'periodontics', basePrice: 800000, duration: 60 },
  { id: 'SV030', name: 'Phủ Flour cho trẻ', type: 'treatment', category: 'pediatric', basePrice: 200000, duration: 20 }
];
...
export const getBookingChannelStatistics = async (params = {}) => {
  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      ...
      // Top staff who book offline - EXPANDED to 20 staff
      const topStaff = [
        { staffId: 'ST001', name: 'Nguyễn Thị Xuân', role: 'receptionist', count: Math.floor(totalOffline * 0.18), efficiency: 95.2 },
        { staffId: 'ST002', name: 'Trần Văn Yên', role: 'receptionist', count: Math.floor(totalOffline * 0.16), efficiency: 93.8 },
        { staffId: 'ST003', name: 'Lê Thị Zoe', role: 'receptionist', count: Math.floor(totalOffline * 0.15), efficiency: 92.5 },
        { staffId: 'ST004', name: 'Phạm Văn An', role: 'receptionist', count: Math.floor(totalOffline * 0.12), efficiency: 91.0 },
        { staffId: 'ST005', name: 'Hoàng Thị Bình', role: 'receptionist', count: Math.floor(totalOffline * 0.07), efficiency: 89.2 },
        { staffId: 'ST006', name: 'Ngô Văn Cường', role: 'admin', count: Math.floor(totalOffline * 0.12), efficiency: 94.5 },
        { staffId: 'ST007', name: 'Đỗ Thị Diệu', role: 'admin', count: Math.floor(totalOffline * 0.09), efficiency: 93.0 },
        { staffId: 'ST008', name: 'Vũ Văn Em', role: 'manager', count: Math.floor(totalOffline * 0.07), efficiency: 96.8 },
        { staffId: 'ST009', name: 'Bùi Thị Phương', role: 'manager', count: Math.floor(totalOffline * 0.04), efficiency: 95.5 },
        { staffId: 'ST010', name: 'Đặng Văn Giang', role: 'receptionist', count: Math.floor(totalOffline * 0.05), efficiency: 88.3 },
        { staffId: 'ST011', name: 'Võ Thị Hương', role: 'receptionist', count: Math.floor(totalOffline * 0.04), efficiency: 87.5 },
        { staffId: 'ST012', name: 'Phan Văn Khôi', role: 'receptionist', count: Math.floor(totalOffline * 0.04), efficiency: 86.8 },
        { staffId: 'ST013', name: 'Lý Thị Lan', role: 'receptionist', count: Math.floor(totalOffline * 0.03), efficiency: 85.2 },
        { staffId: 'ST014', name: 'Trương Văn Minh', role: 'admin', count: Math.floor(totalOffline * 0.03), efficiency: 90.5 },
        { staffId: 'ST015', name: 'Nguyễn Thị Ngọc', role: 'receptionist', count: Math.floor(totalOffline * 0.02), efficiency: 84.0 },
        { staffId: 'ST016', name: 'Trần Văn Ông', role: 'receptionist', count: Math.floor(totalOffline * 0.02), efficiency: 83.5 },
        { staffId: 'ST017', name: 'Lê Thị Phượng', role: 'receptionist', count: Math.floor(totalOffline * 0.02), efficiency: 82.8 },
        { staffId: 'ST018', name: 'Phạm Văn Quân', role: 'receptionist', count: Math.floor(totalOffline * 0.02), efficiency: 82.0 },
        { staffId: 'ST019', name: 'Hoàng Thị Rồng', role: 'admin', count: Math.floor(totalOffline * 0.01), efficiency: 89.0 },
        { staffId: 'ST020', name: 'Ngô Văn Sơn', role: 'receptionist', count: Math.floor(totalOffline * 0.01), efficiency: 81.2 }
      ];
...
export const getPatientRetentionStatistics = async (params = {}) => {
  ...
  return new Promise((resolve) => {
    setTimeout(() => {
      ...
      // Top loyal patients - EXPANDED (50 patients)
      const loyalPatients = [
        { patientId: 'P001', name: 'Nguyễn Văn Anh', phone: '0901234567', totalVisits: 28, totalSpent: 145000000, firstVisit: '2022-11-15', lastVisit: '2024-11-05', frequency: 2.8 },
        { patientId: 'P002', name: 'Trần Thị Bảo', phone: '0907654321', totalVisits: 24, totalSpent: 128000000, firstVisit: '2023-01-20', lastVisit: '2024-11-03', frequency: 2.4 },
        { patientId: 'P003', name: 'Lê Văn Cường', phone: '0912345678', totalVisits: 22, totalSpent: 115000000, firstVisit: '2023-02-10', lastVisit: '2024-10-28', frequency: 2.2 },
        { patientId: 'P004', name: 'Phạm Thị Diệu', phone: '0923456789', totalVisits: 20, totalSpent: 98000000, firstVisit: '2023-03-15', lastVisit: '2024-10-25', frequency: 2.0 },
        { patientId: 'P005', name: 'Hoàng Văn Em', phone: '0934567890', totalVisits: 19, totalSpent: 92000000, firstVisit: '2023-04-20', lastVisit: '2024-10-20', frequency: 1.9 },
        { patientId: 'P006', name: 'Ngô Thị Phương', phone: '0945678901', totalVisits: 18, totalSpent: 87000000, firstVisit: '2023-04-25', lastVisit: '2024-10-18', frequency: 1.8 },
        { patientId: 'P007', name: 'Đỗ Văn Giang', phone: '0956789012', totalVisits: 17, totalSpent: 82000000, firstVisit: '2023-05-10', lastVisit: '2024-10-15', frequency: 1.7 },
        { patientId: 'P008', name: 'Vũ Thị Hương', phone: '0967890123', totalVisits: 16, totalSpent: 78000000, firstVisit: '2023-05-15', lastVisit: '2024-10-12', frequency: 1.6 },
        { patientId: 'P009', name: 'Bùi Văn Khôi', phone: '0978901234', totalVisits: 15, totalSpent: 74000000, firstVisit: '2023-06-01', lastVisit: '2024-10-10', frequency: 1.5 },
        { patientId: 'P010', name: 'Đặng Thị Lan', phone: '0989012345', totalVisits: 15, totalSpent: 72000000, firstVisit: '2023-06-10', lastVisit: '2024-10-08', frequency: 1.5 },
        { patientId: 'P011', name: 'Võ Văn Minh', phone: '0990123456', totalVisits: 14, totalSpent: 68000000, firstVisit: '2023-06-20', lastVisit: '2024-10-05', frequency: 1.4 },
        { patientId: 'P012', name: 'Phan Thị Ngọc', phone: '0901234568', totalVisits: 14, totalSpent: 66000000, firstVisit: '2023-07-01', lastVisit: '2024-10-03', frequency: 1.4 },
        { patientId: 'P013', name: 'Lý Văn Ông', phone: '0912345679', totalVisits: 13, totalSpent: 64000000, firstVisit: '2023-07-15', lastVisit: '2024-10-01', frequency: 1.3 },
        { patientId: 'P014', name: 'Trương Thị Phượng', phone: '0923456780', totalVisits: 13, totalSpent: 62000000, firstVisit: '2023-07-20', lastVisit: '2024-09-28', frequency: 1.3 },
        { patientId: 'P015', name: 'Nguyễn Văn Quân', phone: '0934567891', totalVisits: 12, totalSpent: 58000000, firstVisit: '2023-08-01', lastVisit: '2024-09-25', frequency: 1.2 },
