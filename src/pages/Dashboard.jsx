  ...
  const getQuickActions = () => {
    if (role === 'admin' || role === 'manager') {
      return [
        ...
        // Khám & Điều trị
        { key: 'walk-in', label: 'Phiếu hẹn trực tiếp', icon: <UserAddOutlined />, path: '/dashboard/walk-in-appointments', color: '#1890ff' },
      ...
      return [
        ...
        { key: 'walk-in', label: 'Phiếu hẹn trực tiếp', icon: <UserAddOutlined />, path: '/dashboard/walk-in-appointments', color: '#52c41a' },
